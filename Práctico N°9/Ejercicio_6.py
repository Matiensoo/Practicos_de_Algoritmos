...
class LinkedList:
    ...
    def odd(self):
        ...
        while curr:
            if curr.data % 2==1 :
                impar.push_back(curr.data)
            else:
                pass
            curr= curr.next
        return impar.to_list()
    
    def delete_vowel(self):
        consonant = LinkedList()

        curr = self.head
        while curr:
            if curr.data not in ["a", "e", "i", "o", "u"]:
                consonant.push_back(curr.data)
            curr = curr.next
        return consonant.to_list()    
    ...
    def positive_negative(self):
        positives = LinkedList()
        negatives = LinkedList()

        curr = self.head
        while curr:
            if curr.data > 0:
                positives.push_back(curr.data)
            elif curr.data < 0:
                negatives.push_back(curr.data)
            curr = curr.next 
...
lista1= LinkedList(["p","r","u","e","b","a"])

print (lista1.delete_vowel())
